...
You can start by accessing the list of templates in the [Smart contract section](/smart-contract/understanding-smart-contracts.mdx). Then, you can deploy the smart contract from code.
