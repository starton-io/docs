...
-   Deploy it with Starton from the dashboard. To deploy contracts from code, see [Deploying a smart contract from code](deploy-a-contract-from-code.mdx).
...
If you feel stuck or have questions, feel free to get in touch in our [Discord](deploy-a-contract-from-code.mdx).
