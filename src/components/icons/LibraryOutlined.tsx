...
|--------------------------------------------------------------------------
*/
export interface LibraryOutlinedProps extends SvgIconProps {}
...
|--------------------------------------------------------------------------
*/
export const LibraryOutlined: React.FC<LibraryOutlinedProps> = (props) => {
	// Render
	//--------------------------------------------------------------------------
	return (
		<SvgIcon {...props}>
			<svg viewBox="0 0 24 24">
				<path
					...
					fill={props?.fill ?? props?.stroke ?? '#F1F3F5'}
				/>
			</svg>
		</SvgIcon>
	)
