...
import Blog2 from "@site/static/img/guides/2.png"

# How did we build a Meta-Transaction Site with Web3Auth and Starton

<Image img={Blog2} alt={"Starton Web3auth"} />
...
Want to use our project? Go to our tutorial section, [CREATING METATRANSACTIONS WITH WEB3AUTH AND STARTON](/docs/tutorials/starton-web3auth)
