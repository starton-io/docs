...
-   **Contract URI Suffix**: Will be concatenated with baseUri:
...
| mint            | (address to, string metadataURI)                        | Mint a new token with a specified metadata URI and ensure that the to address can receive this token                                                                                        |
