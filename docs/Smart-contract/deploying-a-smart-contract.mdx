---
title: Deploying a smart contract from template
...
You can deploy a smart contract directly from code using the Relayer.

###  Get the list of available templates

Before deploying our contract you can get the list of templates to find one that suits your need.

To do this, you can query Connect’s API. You need to authenticate using an API key.
