...
-   **Discord Communities management simplified**
    ...
    Starton started making community management easy by providing you with a bot to verify roles on Discord. We added a feature for you to reward users using commands on your server. Airdrop tokens and NFTs to create engaged WEB3 communities. [Read More](tools/role-bot-discord.mdx)
...
-   **Multi user collaboration on a project**
    ...
    You can now invite users to work on a project. Users are notified by email. You can see pending invitations, users joining the project, and remove users from a project. [Read more](/settings/create-new-project.mdx#inviting-users-to-your-project)
...
-   **Nonce and Status columns have been added to the transactions list**
    ...
    To enable you to access the most relevant information at a glance, a column has been added for nonces and status on your all activity transactions list. [Read more](/transactions/state-and-status.mdx)
