---
title: How to create your own limited supply token 
---
...
# How to create your own limited supply token 
...
1. Click on Create a cryptocurrency (Fungible Tokens). 

   ![create smart contracts](img/sc-usecase-erc20.png)

1. Click ERC20 Token with fixed supply.
...
axiosInstance.post(
	"/v3/smart-contract/YOUR_SMART_CONTRACT_NETWORK/YOUR_SMART_CONTRACT_ADDRESS/call",
	{
...
1. Congratulations! You've transferred your first token.
