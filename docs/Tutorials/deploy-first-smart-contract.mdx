...
-   [Starton wallet](https://starton.io/). At creation, Starton provides you with faucet on some networks to fund your first deployment. 
...
-   More on [deploying a Smart Contract from bytecode](/Smart-contract/deploy-from-bytecode.md)
