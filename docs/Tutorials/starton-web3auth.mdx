...
Now that you have used our project, visit this guide to learn more about the project [How did we build a Meta-Transaction Site with Web3Auth and Starton](https://docs.starton.io/blog/web3auth).
