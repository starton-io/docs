...
<Tabs>
    <TabItem value="dashboard" label="From Dashboard">
        <div><ol>
               <li>From Dashboard, go to <Link href="https://app.starton.com/projects/default/wallet">Wallet</Link>.</li>
   ...
   <br/><br/></div>
    ...
    For this tutorial, you will create a wallet on Starton's KMS. But when you want to go on production, you should import your own KMS<Link href="https://docs.starton.com/docs/wallet/connecting-aws-kms">Learn more</Link>.
   <br/><br/>
...
starton.post("/v3/kms/wallet", {
   "description": "string",
   "name": "string",
   "kmsId": "kms_00000000000000000000000000000000"
})
...
-   We used the [Starton KMS](/docs/wallet/understanding-key-management-systems) to sign the transaction and pay gas fee. This allows you to [automate transactions](/guides/blockchain-transaction-lifecycle), but also to sponsor the end-user fees with [gasless transaction](/docs/tutorials/metatransaction)
...
<CardTitle
	icon={<Starton fill="primary" />}
	href="https://app.starton.com/projects/default/smart-contract"
	target="_blank"
>
...
<div className="row-is-multilineGS">
	<div className="col col-2 cardsGS">
		<Link
			...
			href="/docs/smart-contract/interacting-with-a-smart-contract"
		>
	...
	<div className="col col-2 cardsGS">
		<Link className="button-card button-card--vertical" href="/docs/tutorials/monitoring-blockchain-activity">
