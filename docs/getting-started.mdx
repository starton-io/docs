...
<a href="/docs/Tutorials/deploy-first-smart-contract"><h3>Deploy</h3>
...
<div class="col col--2" class="cards">
<a href="/docs/Tutorials/storing-files-on-IPFS"><h3>Store</h3>
<div class="button-card__inner">
...
<div class="col col--2" class="cards">
<a href="/docs/Tutorials/monitoring-blockchain-activity"><h3>Monitor</h3>
<div class="button-card__inner">
