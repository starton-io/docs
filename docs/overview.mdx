...
title: Overview 
---
import Relayer from './src/relayer.png';

# Starton Overview 

Our goal at **Starton** is to enable anyone to **deploy or interact with smart contracts** and **monitor the most used blockchains and networks** without much prior knowledge of blockchain technology.
...
- **Monitor** empowers your application by **creating watchers returning specific events** happening on a chosen blockchain.
