...
import Consumption from "./src/consumption.png"
import Prediction from "./src/prediction.png"
...
<img src={Dashboard} style={{ width: 700 }} />
...
<img src={Consumption} style={{ width: 600 }} />
...
<img src={Prediction} style={{ width: 600 }} />
...
-   More on [Compute units](/Dashboard/compute-units.mdx)
-   More on [Transactions](/Transactions/understanding-the-relayer.mdx)
