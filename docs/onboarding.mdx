...
You created your first API key. Learn how to authenticate using your API key in your application in our [Developer](/Developer/API.mdx) section.
...
You can also import your own KMS at any time and change ownership of your Smart contract. Read more in [Tutorials](/Tutorials/how-to-change-the-smart-contracts-ownership.mdx).
