...
<CardTitle icon={<Starton fill="primary" />} href="/docs/services/library/fungible-token">
	Fungibles tokens (ERC20)
</CardTitle>
<br />
<CardTitle icon={<Starton fill="primary" />} href="/docs/services/library/non-fungible-token">
	Non Fungible Tokens (NFT ERC721 & ERC1155)
</CardTitle>
<br />
<CardTitle icon={<Starton fill="primary" />} href="/docs/services/library/other">
	Tools
</CardTitle>
<br />
