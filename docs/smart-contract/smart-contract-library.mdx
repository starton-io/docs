...
<CardTitle icon={<Starton fill="primary" />} href="/blog/fungible-vs-non-fungible-tokens#fungible-tokens">
	Fungibles tokens (ERC20)
</CardTitle>
<br />
<CardTitle icon={<Starton fill="primary" />} href="/blog/fungible-vs-non-fungible-tokens#non-fungible-tokens">
