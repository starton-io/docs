...
Transactions in a blocked status require a manual action on your part. Check [Blocked transactions troubleshooting](/transactions/manual-action-required.mdx) for more information.
